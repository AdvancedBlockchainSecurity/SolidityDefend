...
> **Current baseline:** see [v2.0.15-baseline.md](v2.0.15-baseline.md), generated by `scripts/baseline.sh`.
> Recall 149/149 (100%), clean-contract FPs 0, precision 61.6% (up from 46.7% in v2.0.14 after
> the ADV-231 detector fixes). The remaining 93 findings all land on vulnerable contracts; a
> large share is stale annotation in this dataset (v1.4.0, pre-dating several detectors) rather
> than detector error — a reconciliation TODO, not a regression.
...
- [v2.0.15-baseline.md](v2.0.15-baseline.md) — **current** baseline (90 detectors, recall 149/149, clean FPs 0, precision 61.6%); generated by `scripts/baseline.sh`
- [v2.0.14-baseline.md](v2.0.14-baseline.md) — first reliable baseline (recall 149/149, clean FPs 0, precision 46.7%)
...
| v2.0.15 | v27 | centralization/block-dependency/gas-griefing corrected (ADV-231); line-1 dedup (ADV-230) | 77 (170→93 GT FPs; precision 46.7%→61.6%) | 132 (18-target) | 0 | 149/149 |
